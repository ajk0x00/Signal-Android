...
constructor(
  ...
  fun update() {
    ...
    try {
      ...
      // Release builds resolve release-only runtime dependencies (such as Cloud Storage, OpenTelemetry, etc.)
      runGradle("--write-verification-metadata", "sha256", "assemblePlayProdRelease", "assembleWebsiteProdRelease", "--no-configuration-cache")
