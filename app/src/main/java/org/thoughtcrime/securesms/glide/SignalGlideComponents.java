...
import org.thoughtcrime.securesms.stories.saved.CloudStorageThumbnailLoader;
...
public class SignalGlideComponents implements RegisterGlideComponents {
  ...
  public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
    ...
    registry.append(CloudStorageThumbnailLoader.CloudStorageThumbnailKey.class, InputStream.class, new CloudStorageThumbnailLoader.Factory());
